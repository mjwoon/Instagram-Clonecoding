...
import SectionBody from "../../components/DM/Section/SectionBody";
import SectionHeader from "../../components/DM/Section/SectionHeader";
...
import {
  ...
  lookUpChatRoom,
  reissueChatList,
} from "../../redux/reducers/DM/DirectThunk";
import {
  addChatMessageItem,
  addSubChatCount,
            ...
            async ({ body }) => {
              ...
              switch (newMessage.action) {
                ...
                case "MESSAGE_LIKE":
                  ...
                  dispatch(
                    likeChatMessageItem({
                      messageId: newMessage.data.messageId,
                      userInfo: userInfo as AuthType.UserInfo,
                    })
                  );
