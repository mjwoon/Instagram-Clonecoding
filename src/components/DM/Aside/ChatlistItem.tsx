    ...
    >
      {isGroupChat ? (
        <div className="group-user-image-container">
          <img src={opponents[0].imageUrl} alt="avatarImg" className="first" />
          <img src={opponents[1].imageUrl} alt="avatarImg" className="second" />
        </div>
      ) : (
        <img
      ...
      <div className="right-section-container">
        <div className="user-nickName">
          {/* 1:1 대화일때랑 단톡일때 구분 */}
          {isGroupChat
            ? opponents.map((opponent) => opponent.username).join(",")
