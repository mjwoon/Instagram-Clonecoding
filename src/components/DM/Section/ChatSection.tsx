...
import { lookUpChatMessageList } from "../../../redux/reducers/DM/DirectThunk";
import {
          ...
          <ChatBubble
            ...
            showDate={
              index === 0
                ...
                : index >= 1 &&
                  Math.abs(
                    moment(chatMessageList[index - 1].messageDate).diff(
                      moment(chatMessageListItem.messageDate),
                      "minute"
                    )
                  ) > 10
            }
            me={userInfo?.memberId === chatMessageListItem.sender.id}
            {...chatMessageListItem}
