...
interface ChatBubbleProps {
  content: string | Direct.PostMessageDTO | CommonType.ImageInfo; 
...
const ChatBubbleContainer = styled.div<ChatBubbleContainerType>`
  ...
  .content {
    ...
    .guide-part {
      ...
      svg {
        display: ${(props) =>
          props.showThreeDotsButton || props.showGuide ? "block" : "none"};
        margin: 0 5px;
    ...
    p {
      ...
      white-space: normal;
      background: ${(props) =>
        props.me ? "rgba(var(--bb2, 239, 239, 239), 1)" : "transparent"};
...
const ChatBubble = ({
  ...
  useEffect(() => {
    ...
    setShowGuide(selectedMessageId === messageId && modal !== "likedMember");
        ...
        return (
          <div className="post-image-container">
            <div className="uploader-info">
              <img src={content.uploader.memberImageUrl} alt="uploader-image" />
                ...
                {me ? (
                  <button
                    onClick={() => {
                      ...
                      dispatch(setCloseModalSelectedMessageId());
                    }}
                  >
                    전송 취소
                  </button>
